...
export default async function main(): Promise<void> {
  ...
  program
    .name("balance-monitor-cli")
    .description("CLI for monitoring actor balances")
    .addCommand(run);
...
main()
  .then(() => {
    console.log(`balance-monitor-cli ran to completion`);
    process.exit(0);
  })
  .catch((e) => {
    console.log(`balance-monitor-cli exited with error: ${e}`);
    process.exit(1);
  });
