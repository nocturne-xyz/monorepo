...
export type DepositRequest_Filter = {
  ...
  createdAtTotalEntityIndex_not_in?: InputMaybe<
...
export type SdkEvent_Filter = {
  ...
  encodedOrEncryptedNote_contains_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  encodedOrEncryptedNote_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  encodedOrEncryptedNote_ends_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  ...
  encodedOrEncryptedNote_not_contains_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  encodedOrEncryptedNote_not_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  encodedOrEncryptedNote_not_ends_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  encodedOrEncryptedNote_not_in?: InputMaybe<Array<Scalars["String"]["input"]>>;
  encodedOrEncryptedNote_not_starts_with?: InputMaybe<
    Scalars["String"]["input"]
  >;
  encodedOrEncryptedNote_not_starts_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  encodedOrEncryptedNote_starts_with?: InputMaybe<Scalars["String"]["input"]>;
  encodedOrEncryptedNote_starts_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex?: InputMaybe<Scalars["BigInt"]["input"]>;
  filledBatchWithZerosUpToMerkleIndex_gt?: InputMaybe<
    Scalars["BigInt"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex_gte?: InputMaybe<
    Scalars["BigInt"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex_in?: InputMaybe<
    Array<Scalars["BigInt"]["input"]>
  >;
  filledBatchWithZerosUpToMerkleIndex_lt?: InputMaybe<
    Scalars["BigInt"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex_lte?: InputMaybe<
    Scalars["BigInt"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex_not?: InputMaybe<
    Scalars["BigInt"]["input"]
  >;
  filledBatchWithZerosUpToMerkleIndex_not_in?: InputMaybe<
    Array<Scalars["BigInt"]["input"]>
  >;
  id?: InputMaybe<Scalars["ID"]["input"]>;
  id_gt?: InputMaybe<Scalars["ID"]["input"]>;
...
export type TreeInsertionEvent_Filter = {
  ...
  filledBatchWithZerosEvent_contains_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  filledBatchWithZerosEvent_ends_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  ...
  filledBatchWithZerosEvent_not_contains?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_not_contains_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_not_ends_with?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_not_ends_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_not_in?: InputMaybe<
    Array<Scalars["String"]["input"]>
  >;
  filledBatchWithZerosEvent_not_starts_with?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_not_starts_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_starts_with?: InputMaybe<
    Scalars["String"]["input"]
  >;
  filledBatchWithZerosEvent_starts_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  id?: InputMaybe<Scalars["ID"]["input"]>;
  id_gt?: InputMaybe<Scalars["ID"]["input"]>;
...
export type FetchDepositRequestUpdatesQueryVariables = Exact<{
  spender: Scalars["Bytes"]["input"];
  createdAtIndices?: InputMaybe<
    Array<Scalars["BigInt"]["input"]> | Scalars["BigInt"]["input"]
  >;
}>;

export type FetchDepositRequestUpdatesQuery = {
  __typename?: "Query";
  depositRequests: Array<{
    __typename?: "DepositRequest";
    spender: any;
    status: DepositRequestStatus;
    encodedAssetAddr: any;
    encodedAssetId: any;
    value: any;
    depositAddrH1: any;
    depositAddrH2: any;
    nonce: any;
    gasCompensation: any;
    instantiationTxHash: any;
    completionTxHash?: any | null;
    retrievalTxHash?: any | null;
    createdAtTotalEntityIndex: any;
  }>;
};
...
export type FetchDepositRequestsQuery = {
  __typename?: "Query";
  depositRequests: Array<{
    __typename?: "DepositRequest";
    spender: any;
...
export const FetchDepositRequestUpdatesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "fetchDepositRequestUpdates" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "spender" },
          },
          type: {
            kind: "NonNullType",
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "createdAtIndices" },
          },
          type: {
            kind: "ListType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "depositRequests" },
            arguments: [
              {
                kind: "Argument",
                ...
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      name: {
                        kind: "Name",
                        value: "createdAtTotalEntityIndex_in",
                      },
                      value: {
                        kind: "Variable",
                        name: { kind: "Name", value: "createdAtIndices" },
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "spender" } },
                { kind: "Field", name: { kind: "Name", value: "status" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "encodedAssetAddr" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "encodedAssetId" },
                },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "depositAddrH2" },
                },
                { kind: "Field", name: { kind: "Name", value: "nonce" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "gasCompensation" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "instantiationTxHash" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "completionTxHash" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "retrievalTxHash" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "createdAtTotalEntityIndex" },
                },
              ],
            },
          },
  ...
  FetchDepositRequestUpdatesQuery,
  FetchDepositRequestUpdatesQueryVariables
>;
export const FetchDepositRequestsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FetchDepositRequestsQueryVariables
>;
