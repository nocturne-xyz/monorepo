...
export function depositRequestResponseToDepositRequestWithMetadata(spender: Address, depositRequestResponse: ArrayElem<GoerliFetchDepositRequestsQuery["goerli_deposit_requests"]>): DisplayDepositRequestWithMetadataAndStatus {
  const {
    encoded_asset_addr,
    encoded_asset_id,
    value,
