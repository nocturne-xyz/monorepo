import { AssetTrait, IncludedEncryptedNote, IncludedNote, Nullifier, StealthAddressTrait, TotalEntityIndex, TotalEntityIndexTrait, WithTotalEntityIndex, batchOffsetToLatestMerkleIndexInBatch } from "@nocturne-xyz/core";
import { Client as UrqlClient } from "@urql/core";
import { SdkEventsPaginatedById } from "./gql/queries/SdkEventsPaginatedById";
import { FetchSdkEventsQuery } from "./gql/autogenerated/graphql";
import { ethers } from "ethers";
import { LatestIndexedBlock } from "./gql/queries/LatestIndexedBlock";

type ArrayElemType<T> = T extends Array<infer U> ? U : never;
