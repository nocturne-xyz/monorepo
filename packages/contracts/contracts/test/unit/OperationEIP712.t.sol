...
contract OperationEIP712Test is Test {
    ...
    function testOperationHashMatchesOffchainImpl() public {
        ...
        bytes32 hashOfPublicJoinSplitsArrayHash = keccak256(abi.encodePacked(publicJoinSplitArrayHash));
        console.log("hashOfPublicJoinSplitsArrayHash:");
        console.logBytes32(hashOfPublicJoinSplitsArrayHash);
        console.log("");

        bytes32 hashOfJoinSplitsArrayHash = keccak256(abi.encodePacked(joinSplitsArrayHash));
