...
export async function fetchNotesFromRefunds(contract: Wallet, from: number, to: number): Promise<IncludedNote[]> {
...
export async function fetchJoinSplits(contract: Wallet, from: number, to: number): Promise<JoinSplitEvent[]> {
