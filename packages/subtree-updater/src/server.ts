...
import { Accountant__factory } from "@nocturne-xyz/contracts";
...
export class SubtreeUpdateServer {
  ...
  constructor(
    ...
    const accountantContract = Accountant__factory.connect(
    ...
    this.updater = new SubtreeUpdater(accountantContract, rootDB, prover);
    this.stopped = true;
  }
