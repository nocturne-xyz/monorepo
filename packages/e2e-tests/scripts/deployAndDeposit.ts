...
const TEST_CANONICAL_NOCTURNE_ADDRS: CanonAddress[] = [
  ...
  // sebastien 2
  {
    x: 20439999761220200627653770020158877508140845905143935573142129014346648768249n,
    y: 9675620194711398684922631646170919146789143142546498977256370178369366149085n
  }
];
