...
export type Erc20PluginExt<T extends BaseOpRequestBuilderMethods> = T &
  Erc20PluginMethods;

export function Erc20Plugin<EInner extends BaseOpRequestBuilderMethods>(
